...
func SelectMigrations(tx dblib.Queryable, cond string, condFields ...interface{}) ([]*Migrations, error) {
	ret := []*Migrations{}
...
func (s *Migrations) Update(tx dblib.Queryable) error {
...
func (s *Migrations) Insert(tx dblib.Queryable) error {
...
func (s *Migrations) Delete(tx dblib.Queryable) error {
...
func CreateMigrationsTable(tx dblib.Queryable) error {
	stmt, err := tx.Prepare(`
